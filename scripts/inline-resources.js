...
/**
 * Replaces every mention of scss with css
 * @param content {string} The source file's content.
 * @returns {string} The content with all scss mentions replaced.
 */
function replaceScssToCss(content) {
  return content.replace(/.scss/gm, '.css')
}
